...
set(OMPL_VERSION 1.5.2)
set(OMPL_MAJOR_VERSION 1)
set(OMPL_MINOR_VERSION 5)
set(OMPL_PATCH_VERSION 2)

set_and_check(OMPL_INCLUDE_DIR "${PACKAGE_PREFIX_DIR}/include/ompl-1.5")
set(OMPL_INCLUDE_DIRS "${OMPL_INCLUDE_DIR};/opt/homebrew/include;/opt/homebrew/include/eigen3")
foreach(_dir /opt/homebrew/Cellar/flann/1.9.1_13/include;/opt/homebrew/Cellar/ode/0.16.2/include;;TRIANGLE_INCLUDE_DIR-NOTFOUND;;;;)
    if(_dir)
...
set(OMPL_LIBRARY_DIRS "${OMPL_LIBRARY_DIR};/opt/homebrew/lib")
foreach(_dir /opt/homebrew/Cellar/flann/1.9.1_13/lib;/opt/homebrew/Cellar/ode/0.16.2/lib;;;)
    if(_dir)
...
foreach(_lib /opt/homebrew/lib/libboost_serialization-mt.dylib;/opt/homebrew/lib/libboost_filesystem-mt.dylib;/opt/homebrew/lib/libboost_system-mt.dylib;ode;)
    if(_lib)
